...
async function sendWelcomeEmail(newUser) {
  const html = `
    ...
    <p>You can now start increasing your conversion rates by creating new experiments with out platform.</p>
    <p>Don't have a clear idea on what to test? Start by making text variations of your main elements! Such as your h1, CTA, etc. Plenty of CR potential is usually locked inside simple tweaks of this nature.</p>
