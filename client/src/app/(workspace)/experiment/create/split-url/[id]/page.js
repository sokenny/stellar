...
import CreateSplitUrlExperimentForm from '../../../../../components/CreateSplitUrlExperimentForm';
  ...
  return (
    <div className={styles.CreateExperiment}>
      <Breadcrumbs className={styles.breadCrumbs}>
        ...
        <BreadcrumbItem>Split URL</BreadcrumbItem>
      </Breadcrumbs>
      {isNew ? (
        <h1 className={styles.title}>Create a Split URL Experiment</h1>
      ) : (
        <ExperimentName
      ...
      <CreateSplitUrlExperimentForm experimentId={id} />
    </div>
  );
}
