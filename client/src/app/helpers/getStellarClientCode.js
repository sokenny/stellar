...
<link rel="preload" href="${process.env.NEXT_PUBLIC_STELLAR_PUBLIC_JS_HOST}/public/clientjs" as="script">
<script async src="${process.env.NEXT_PUBLIC_STELLAR_PUBLIC_JS_HOST}/public/clientjs" data-stellar-api-key="${apiKey}"></script>
<!-- Stellar code ends -->
`;
}
